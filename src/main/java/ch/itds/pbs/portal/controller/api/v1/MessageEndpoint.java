...
public class MessageEndpoint {
    ...
    @PutMapping("message")
    @Transactional
    public ResponseEntity<?> list(@Parameter(description = "Message") @RequestBody MessageCreateRequest messageCreateRequest, @CurrentUser TileAuthentication authentication) {
